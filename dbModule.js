...
async function setResidents(r) {
    let d = db.query("INSERT INTO residents (`apartmentId`, `firstName`, `lastName`, `phone1`, `phone2`, `email`) VALUES(" + r.apartmentId + ",'" + r.firstName + "','" + r.lastName + "','" + r.phone1 + "','" + r.phone2 + "','" + r.email + "')");
    let a = await d;
    return a;
}